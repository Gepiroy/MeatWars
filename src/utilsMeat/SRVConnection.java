...
public class SRVConnection {
	...
	public void TryToCreateTable()
	{
		...
		try {
			...
			state.executeUpdate("CREATE TABLE IF NOT EXISTS " + database + "." + table +
					" (BungeeName TEXT(20),ConFails INT NOT NULL DEFAULT 0,CanPlay BOOL DEFAULT 1,Type INT NOT NULL DEFAULT 2,Ip TEXT,Port INT NOT NULL DEFAULT 25565);"
					);
	...
	public void NewStats()
	{
		...
		try {
			...
			if(!res.next()) state.executeUpdate("INSERT INTO " + database + "." + table + " (BungeeName) VALUES('" + server + "');");
